/**
 * Loopback trust fence for the /api/dsh-chat-history route family: socket
 * address, Host header, and browser same-origin markers (same semantics as
 * the dsh-ssh loopback fence). These routes mutate the workspace archive set,
